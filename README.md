...
Version 2.0 was performed using the original data Version 1.0. 

information on the original 1.0 version can be found at:
http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones 

the original data Version 1.0 can be found at:
...
The original 1.0 dataset includes the following files:
=========================================
